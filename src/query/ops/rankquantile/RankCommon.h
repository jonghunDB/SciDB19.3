...
public:
    ...
    DelegateArrayIterator* createArrayIterator(const AttributeDesc& attrID_in) const override
    {
        ...
        {
            return new DelegateArrayIterator(*this, attrID_in, inputArray->getConstIterator(_inputAttributeID));
        }
        else
        {
            ...
            auto etID = inputArray->getArrayDesc().getEmptyBitmapAttribute();
            assert(etID);
            return new DelegateArrayIterator(*this, attrID_in, inputArray->getConstIterator(*etID));
        }
    }
...
public:
    ...
    DelegateArrayIterator* createArrayIterator(const AttributeDesc& attrID_in) const override
    {
        ...
        {
            return new DelegateArrayIterator(*this, attrID_in, inputArray->getConstIterator(attrID_in));
        }
        else
        {
            //Client must be asking for empty tag
...
public:
    ...
    {
        const auto& inputAttrs = inputArray->getArrayDesc().getAttributes();
