...
void MessageHandleJob::reschedule(uint64_t delayMicroSec)
{
    ...
    try {
        ...
        typedef boost::function<void(const boost::system::error_code& error)> TimerCallback;
...
void ServerMessageHandleJob::handlePreparePhysicalPlan()
{
    ...
    ScopedActiveQueryThread saqt(_query, PTW_SPCL_ACTIVE_I);
...
void ServerMessageHandleJob::handleQueryResult()
{
    ...
    ScopedActiveQueryThread saqt(_query, PTW_SPCL_ACTIVE_J);
...
void ServerMessageHandleJob::handleCommit()
{
    ...
    ScopedActiveQueryThread saqt(_query, PTW_SPCL_ACTIVE_K);
