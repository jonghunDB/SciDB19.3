        ...
        _livenessSubscriberID(0)
{
    ...
    Scheduler::Work func = boost::bind(&NetworkManager::handleLiveness);
                         ...
                         const std::string& address)
{
    ...
    Notification<InstanceLiveness>::Subscriber listener = boost::bind(&handleLivenessNotification, _1);
...
void NetworkManager::startInputWatcher()
{
   ...
   _input.async_read_some(boost::asio::buffer((void*)&one_byte_buffer,sizeof(one_byte_buffer)),
                          boost::bind(&NetworkManager::handleInput, this,
                                     ...
                                     const std::shared_ptr<MessageDesc>& messageDesc)
{
    ...
    try
    {
        ...
        if (connection && !sess) {
            ...
            job->dispatch(this);
            handler = boost::bind(&NetworkManager::publishMessage, _1);
        }
