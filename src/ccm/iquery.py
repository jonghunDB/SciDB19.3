...
class Iquery(cmd.Cmd, object):
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            self.history_file = os.path.join(xdg_config_home, 'scidb', 'iquery-py.history')
        except ImportError:
            self.history_file = os.path.join(os.environ['HOME'], '.iquery-py.history')
    ...
    def default(self, a):
        """The default action is how an AFL Query, or iquery.py command is parsed and
        executed.

        Entries starting with 'set' are processed as iquery.py settings,
