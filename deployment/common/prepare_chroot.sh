...
function pbuilder_prep ()
{
    ...
    echo "python -m pip install --upgrade pip" >> /var/cache/pbuilder/hook.d/A01build_prep
    echo "python -m pip install --upgrade cmake" >> /var/cache/pbuilder/hook.d/A01build_prep
    echo "python -m pip install --upgrade --ignore-installed protobuf" >> /var/cache/pbuilder/hook.d/A01build_prep
